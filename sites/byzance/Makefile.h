...
HYPRE_PATH = /home/rth/src2/hypre
EOSPAC_PATH = /mnt/perso/luli/eos/eospack/eospac6/Source
...
OPENMP = -fopenmp
FFLAGS_EOSPAC = -I${EOSPAC_PATH}/include/x86_64-unknown-linux-gnu/gcc

FFLAGS_OPT = -ggdb -c -O2 -fdefault-real-8 -fdefault-double-8 \
-Wuninitialized ${FFLAGS_EOSPAC}
...
FFLAGS_HYPRE = -I${HYPRE_PATH}/include #/hypre
...
CFLAGS_OPT = -ggdb -c -O2 -Wuninitialized -D_FORTIFY_SOURCE=2 -I${HYPRE_PATH}/include #/hypre
...
#----------------------------------------------------------------------------
LIB_EOSPAC= -L${EOSPAC_PATH}/lib/x86_64-unknown-linux-gnu/gcc/ -leospac6
...
#eos_eospacData.o : %.o : %.F90
#	$(FCOMP) $(FFLAGS_OPT) $(FFLAGS_EOSPAC)  $(F90FLAGS) $(FDEFINES)    $<
#
#eos_initEospac.o : %.o : %.F90  eos_eospacdata.mod
#	$(FCOMP) $(FFLAGS_OPT) $(FFLAGS_EOSPAC)  $(F90FLAGS) $(FDEFINES)    $<
