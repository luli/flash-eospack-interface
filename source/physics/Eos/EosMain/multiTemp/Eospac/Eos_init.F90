!!****if* source/physics/Eos/EosMain/multiTemp/Eospac/Eos_init
!!
!! NAME
!!
!!  Eos_init
...
!!  NOTES
!!
!!   Eos defines at least two mesh-based parameters GAMC_VAR and GAME_VAR in Flash.h
!!
!!***
subroutine Eos_init()
...
#include "Eos.h"  
  ...
  ! call eos_initGamma()
  call eos_initMgamma()
  !call eos_initMtemp()     ! a stub
  call eos_initTabulated() ! still needed for opacity
  call eos_initEospac()
